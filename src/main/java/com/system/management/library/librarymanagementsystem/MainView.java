...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Library Management System");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Library", "la la-book-open", LibraryView.class),
                new MenuItemInfo("Add new record", "la la-plus", AddNewRecordView.class),
        };
    }
    ...
    private Footer createFooter() {
        ...
        layout.add(new H4("Please note that all records are removed every 3 hours."));
